...
<body>
    ...
    <div class="form-container">
        ...
        <%  
            int v_product_id = Integer.parseInt(request.getParameter("product_id"));
            String v_field = request.getParameter("field");
            String v_new_value = request.getParameter("new_value");
            
            int status = B.update_product(v_product_id, v_field, v_new_value);
            
            if (status == 1) {
                out.println("<h3 style='color: green;'>Product Record Updated Successfully</h3>");
            } else {
                out.println("<h3 style='color: red;'>Failed to Update Product Record</h3>");
            }
        %>

        <form action="updateProduct.jsp">
            <input type="submit" value="Update Another Product Record">
        </form>
    </div>
