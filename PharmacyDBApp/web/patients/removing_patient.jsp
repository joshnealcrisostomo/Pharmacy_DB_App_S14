...
<html>
<head>
    <title>Remove a Patient Record</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="form-container">
        <%  
            ...
            int status = A.remove_patient(v_patient_id);
            
            if (status == 1) {
                out.println("<h2>Patient Record Removed Successfully</h2>");
            } else {
                out.println("<h2>Failed to Remove Patient Record</h2>");
            }
        %>

        <form action="removing_patient.jsp">
            <input type="submit" value="Remove Another Patient Record">
        </form>
    </div>
