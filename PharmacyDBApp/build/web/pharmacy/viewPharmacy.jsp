...
<body>
    ...
    <div class="form-container">
        ...
        <!-- Filter Form -->
        <form action="viewPharmacy.jsp" method="get">
        ...
        <%  
            ...
            if (v_fields != null && !v_fields.trim().isEmpty()) {
                D.filter_pharmacy(v_fields.toUpperCase());
            } else {
                D.pharmacies_list();
            }
        %>
        ...
        <div class="table-container">
            <table>
                ...
                %>
                    <tr>
                        <%  
                            if (i < D.pharmacy_idList.size()) { %>
                                <td><%= D.pharmacy_idList.get(i) %></td>
                        <%  }
                            if (i < D.pharmacy_nameList.size()) { %>
                                <td><%= D.pharmacy_nameList.get(i) %></td>
                        <%  }
                            if (i < D.floorList.size()) { %>
                                <td><%= D.floorList.get(i) %></td>
                        <%  }
                            if (i < D.contact_firstList.size()) { %>
                                <td><%= D.contact_firstList.get(i) %></td>
                        <%  }
                            if (i < D.contact_lastList.size()) { %>
